      ...
      try {
        ...
        if (user.length != 0) {
          if (user[0].verified === false) {
            ...
            let html = `<h2>Thanks for Joining Us</h2>
                        <h3>Dear ${user.name} you are one step closer to become one of our prestigious family</h3>
                        <p>To verify your email Click <a href=https://powerful-tor-09724.herokuapp.com/user/verify/${resetToken} >here</a></p>
                        <p>https://powerful-tor-09724.herokuapp.com/user/verify/${resetToken}</p>           
                                  <p>Thank you!!!!</p>`;
